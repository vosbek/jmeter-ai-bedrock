 ...
 * This class processes code from JSR223 elements and sends it to the AI for improvement.
 */
    ...
    private static RSyntaxTextArea findRSyntaxTextArea(Container container) {
        ...
        for (Component component : container.getComponents()) {
            if (component instanceof RSyntaxTextArea) {
                ...
                try {
                    // Use reflection to get the viewport and view since JTextScrollPane might not be in our classpath
                    Container viewport = null;
                    if (component instanceof JScrollPane) {
                        viewport = ((JScrollPane) component).getViewport();
                    } else {
                        // Try to get viewport through reflection
                        java.lang.reflect.Method getViewportMethod = 
                            component.getClass().getMethod("getViewport");
